    ...
    private void addRecentContactsFragment() {
        ...
        fragment.setCallback(new RecentContactsCallback() {
            ...
            public void onRecentContactsLoaded() {
                // 最近联系人列表加载完毕
                Log.i("SessionListFragment","最近联系人列表加载完毕");
            }
...
//                ReminderManager.getInstance().updateSessionUnreadNum(unreadCount);
            ...
            public void onItemClick(RecentContact recent) {
                ...
                switch (recent.getSessionType()) {
                    case P2P:
                        NimUIKit.startP2PSession(getActivity(), recent.getContactId(), null);
                        break;
                    case Team:
                        NimUIKit.startTeamSession(getActivity(), recent.getContactId(), null);
                        break;
                    case SUPER_TEAM:
